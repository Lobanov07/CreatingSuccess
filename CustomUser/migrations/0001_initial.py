# Generated by Django 3.2.16 on 2024-11-03 19:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preparation_time', models.DurationField(default=datetime.timedelta(seconds=900), verbose_name='Время на подготовку')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Профиль создан')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Профиль обновлен')),
